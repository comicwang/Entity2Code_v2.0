...
namespace Utility.Core
{
    public class TemplateContainer : IDisposable
    {
        ...
        private static void RegistAllSource()
        {
            ...
            Regist("DA66A2D1-1F56-4DD6-8CF3-093E4842A3E3", "Map.sem");
            Regist("B1243F2F-EB98-4165-8F6C-0B93F2353A85", "Repository.sem");
            Regist("E9354F4B-CB6B-488F-8E0E-B4AD24C7C246", "Entity.sem");
            Regist("EA8D007E-65ED-4AAE-9E02-988650EEA81F", "Entities.sem");
            Regist("4C22DD8D-A0C5-4616-85C9-AB82CBE2A6E6", "IRepository.sem");
            Regist("E5543E7E-B17D-42A3-9AC2-6565F87E99D4", "Application.sem");
            Regist("68A6482E-C517-46BF-B908-6D735BFE0B4C", "IApplication.sem");
            Regist("B673DE88-23A2-4C33-BA1F-FE2FFDBD1DE0", "Data2Obj.sem");
